        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="p-5">
                    ...
                    <form class="user" method="post" action="{{ route('frontend.handle.login') }}" role="form">
                        {{-- render token trong input hidden --}}
                        @csrf
                        <div class="form-group">
                            <input type="text" class="form-control form-control-user"
                                id="exampleInputEmail" name="emailCustomer" aria-describedby="emailHelp"
                                placeholder="Enter Email Address...">
                        </div>
                        <div class="form-group">
                            <input type="password" class="form-control form-control-user"
                                id="exampleInputPassword" placeholder="Password" name="passwordCustomer">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="text-center">
                        <a class="small" href="{{ route('frontend.register') }}">Create an Account!</a>
                    </div>
                </div>
            </div>
        </div>
